# Generated by Django 3.2.2 on 2021-08-29 08:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Easy_bank_app', '0030_city_home_loan_form1_city_home_loan_form2_city_home_loan_form3_city_home_loan_form4_city_home_loan_f'),
    ]

    operations = [
        migrations.CreateModel(
            name='brac_loan_against_property_form1',
            fields=[
        ...
        migrations.CreateModel(
            name='brac_loan_against_property_form2',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='brac_loan_against_property_form3',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='brac_loan_against_property_form4',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='brac_loan_against_property_form5',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
